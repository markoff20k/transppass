...
O schema Prisma cobre **os oito épicos**; todas as telas do MVP existem em `apps/web` e rodam em modo mock. O QA funcional automatizado (`node tools/qa-smoke.mjs`, 48 verificações de UI) e o relatório em [QA.md](QA.md) registram o que foi exercitado.
